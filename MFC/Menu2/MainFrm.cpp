...
//	GetMenu()->AppendMenu(MF_POPUP,(UINT)menu.m_hMenu,"Winsun");
	GetMenu()->InsertMenu(2,MF_BYPOSITION | MF_POPUP,(UINT)menu.m_hMenu,"WinSum");
	...
	//动态插入菜单或菜单项
	GetMenu()->GetSubMenu(0)->AppendMenu(MF_STRING,114,"WEI");
	GetMenu()->GetSubMenu(0)->InsertMenu(ID_FILE_OPEN,MF_BYCOMMAND | MF_STRING,115,"SDF");
