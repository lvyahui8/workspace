...
{ 
	...
	{
		p1->Output();
		cout<<"1-货物编号   2-货物名称   3-货物单价\n   4-进货总数   5-售出数目   6-剩余库存数目\n   7-修改全部信息\n"<<endl; 
		cout<<"请输入要修改的信息编号：\n";
...
/*
void Supermarket::Add_up()      //统计超市商品总数量与价值
{
	cout<<"\n****商品统计****\n";
...
*/
		outfile<<" "<<p->number;//货物编号\t\t
		outfile<<" "<<p->name;//货物名称\t\t
		outfile<<" "<<p->price;//货物单价\t\t
		outfile<<" "<<p->incount;//进货总数\t\t
		outfile<<" "<<p->outcount;//售出数目\t\t
		outfile<<" "<<p->recount<<endl;//剩余库数目\t\t
