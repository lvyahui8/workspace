...
CREATE TABLE `project_qst` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `project_id` int(11) NOT NULL COMMENT '相关项目的ID',
  `title` varchar(64) NOT NULL COMMENT '问题',
  `answer` varchar(64) NOT NULL COMMENT '解答',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建日期',
  `updated_at` timestamp NULL DEFAULT NULL,
  `type` enum('normal','exam','video','audio','article') NOT NULL DEFAULT 'normal' COMMENT '项目类型',
  PRIMARY KEY (`id`),
  KEY `FK_6ywuhd49vo60o7w9rsmcehx26` (`project_id`),
  CONSTRAINT `FK_6ywuhd49vo60o7w9rsmcehx26` FOREIGN KEY (`project_id`) REFERENCES `video` (`id`)
...
INSERT INTO `project_qst` VALUES (7,11,'hello?','yes','2015-10-05 02:02:03',NULL,'video'),(8,11,'sex?','man','2015-10-05 02:02:03',NULL,'video'),(9,11,'birthy?','77','2015-10-05 02:02:03',NULL,'video'),(10,12,'hello?','yes','2015-10-05 02:17:10',NULL,'video'),(11,12,'sex?','man','2015-10-05 02:17:10',NULL,'video'),(12,12,'birthy?','77','2015-10-05 02:17:10',NULL,'video'),(13,13,'的发个梵蒂冈地方','的发个梵蒂冈','2015-10-05 06:23:33',NULL,'video'),(14,13,'的发个梵蒂冈','的非官方大','2015-10-05 06:23:33',NULL,'video'),(15,13,'发货发货方内部女伴','人锐意哦哦好好好好好好好好好好好好好好好好好好好ijhjgfkhjkfgjkfd','2015-10-05 06:23:33',NULL,'video'),(16,14,'电饭锅','法规和法国dsfdsfsdf','2015-10-05 07:28:40',NULL,'video'),(17,14,'返回分',' 返回分','2015-10-05 07:28:40',NULL,'video'),(18,14,'法规和法国','返回','2015-10-05 07:28:40',NULL,'video');
...
INSERT INTO `video` VALUES (1,26,9,'了快速点击返回的尽快发货','空间的环境看东方航空结果合法的规划','/slsxpt//upload/video/dc4eacc8ba6d0b75a020ee24c4d2c549.MP4','/slsxpt//upload/thumbnail/dc4eacc8ba6d0b75a020ee24c4d2c549.jpg',0,0,0,'2015-10-04 02:51:47','2015-10-04 02:51:47'),(2,26,9,'可是空间划分空间规划','的疯狂的房价会看见了考核结果发了','/slsxpt//upload/video/2da7c9260c2ca837e70668975aeae51d.MP4','/slsxpt//upload/thumbnail/2da7c9260c2ca837e70668975aeae51d.jpg',0,0,0,'2015-10-04 08:03:35','2015-10-04 08:03:35'),(3,26,9,'的看法和高科技奉公克己','空间发的和高考加合法的顾客就会','/slsxpt//upload/video/dc4eacc8ba6d0b75a020ee24c4d2c549.MP4','/slsxpt//upload/thumbnail/dc4eacc8ba6d0b75a020ee24c4d2c549.jpg',0,0,0,'2015-10-04 08:41:47','2015-10-04 08:41:47'),(4,26,9,'的风格的发个梵蒂冈','的发个梵蒂冈大概地方','/slsxpt//upload/video/69b3882c664642f7f033597efc461d9b.MP4','/slsxpt//upload/thumbnail/69b3882c664642f7f033597efc461d9b.jpg',0,0,0,'2015-10-04 14:22:24','2015-10-04 14:22:24'),(9,26,9,'kljfk看看价格','规定非官方的空间规划','/slsxpt//upload/video/8ef7926a6ca471a2a287907b5ff9bc78.MP4','/slsxpt//upload/thumbnail/8ef7926a6ca471a2a287907b5ff9bc78.jpg',0,0,0,'2015-10-04 15:04:59','2015-10-04 15:04:59'),(10,26,9,'空间上的会尽快发货快捷','的发生过的深刻国际化的讲课风格','/slsxpt//upload/video/69b3882c664642f7f033597efc461d9b.MP4','/slsxpt//upload/thumbnail/69b3882c664642f7f033597efc461d9b.jpg',0,0,0,'2015-10-05 01:21:51','2015-10-05 01:21:51'),(11,26,9,'说的话价格肯定发好几个','会尽快恢复的空间规划的反馈结果','/slsxpt//upload/video/8ef7926a6ca471a2a287907b5ff9bc78.MP4','/slsxpt//upload/thumbnail/8ef7926a6ca471a2a287907b5ff9bc78.jpg',0,0,0,'2015-10-05 02:02:03','2015-10-05 02:02:03'),(12,26,9,'的空间和国家开发的后果','快解放和高科技的复合管会计的收费高科技的恢复快关机','/slsxpt//upload/video/2da7c9260c2ca837e70668975aeae51d.MP4','/slsxpt//upload/thumbnail/2da7c9260c2ca837e70668975aeae51d.jpg',0,0,0,'2015-10-05 02:17:10','2015-10-05 02:17:10'),(13,26,9,'的非官方大哥大法官电饭锅','的风格的风格的风格的发个梵蒂冈','/slsxpt//upload/video/a20fc040156863d1fd1959ef2a2bb609.MP4','/slsxpt//upload/thumbnail/a20fc040156863d1fd1959ef2a2bb609.jpg',0,0,0,'2015-10-05 06:23:33','2015-10-05 06:23:33'),(14,27,9,'的反馈结果看见的风格化','的方法的鬼地方个梵蒂冈','/slsxpt//upload/video/8ef7926a6ca471a2a287907b5ff9bc78.MP4','/slsxpt//upload/thumbnail/8ef7926a6ca471a2a287907b5ff9bc78.jpg',0,0,0,'2015-10-05 07:28:40','2015-10-05 07:28:40');
...
-- Dump completed on 2015-10-07 22:14:04
