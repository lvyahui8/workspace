...
CREATE TABLE `video_qst` (
  ...
  CONSTRAINT `FK_orj4pn0wgqjmys65av3um87rr` FOREIGN KEY (`video_id`) REFERENCES `video` (`id`)
...
INSERT INTO `video_qst` VALUES (7,11,'hello?','yes','2015-10-05 02:02:03',NULL),(8,11,'sex?','man','2015-10-05 02:02:03',NULL),(9,11,'birthy?','77','2015-10-05 02:02:03',NULL),(10,12,'hello?','yes','2015-10-05 02:17:10',NULL),(11,12,'sex?','man','2015-10-05 02:17:10',NULL),(12,12,'birthy?','77','2015-10-05 02:17:10',NULL),(13,13,'的发个梵蒂冈地方','的发个梵蒂冈','2015-10-05 06:23:33',NULL),(14,13,'的发个梵蒂冈','的非官方大','2015-10-05 06:23:33',NULL),(15,13,'发货发货方内部女伴','人锐意哦哦好好好好好好好好好好好好好好好好好好好ijhjgfkhjkfgjkfd','2015-10-05 06:23:33',NULL),(16,14,'电饭锅','法规和法国','2015-10-05 07:28:40',NULL),(17,14,'返回分',' 返回分','2015-10-05 07:28:40',NULL),(18,14,'法规和法国','返回','2015-10-05 07:28:40',NULL);
/*!40000 ALTER TABLE `video_qst` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `video_video_qst`
--

DROP TABLE IF EXISTS `video_video_qst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `video_video_qst` (
  `video_id` int(11) NOT NULL,
  `questions_id` int(11) NOT NULL,
  UNIQUE KEY `UK_duwfsqeo6ynfp591jiet6i5gc` (`questions_id`),
  KEY `FK_hiahrt85n2bw2u7d4oe13qpoi` (`video_id`),
  CONSTRAINT `FK_duwfsqeo6ynfp591jiet6i5gc` FOREIGN KEY (`questions_id`) REFERENCES `video_qst` (`id`),
  CONSTRAINT `FK_hiahrt85n2bw2u7d4oe13qpoi` FOREIGN KEY (`video_id`) REFERENCES `video` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `video_video_qst`
--

LOCK TABLES `video_video_qst` WRITE;
/*!40000 ALTER TABLE `video_video_qst` DISABLE KEYS */;
/*!40000 ALTER TABLE `video_video_qst` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-10-06 20:11:52
