...
INSERT INTO `article` VALUES (2,29,7,'artical1','artical text','artical text',0,0,0,'2015-11-13 04:32:20','2015-11-13 04:32:20'),(3,29,7,'artical2','article2','article2',0,0,0,'2015-11-13 04:32:35','2015-11-13 04:32:35');
...
CREATE TABLE `audio_qst` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_g5lx1icm7crej4vvlwhchbo5l` (`audio_id`),
  CONSTRAINT `FK_g5lx1icm7crej4vvlwhchbo5l` FOREIGN KEY (`audio_id`) REFERENCES `audio` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `category` (
  ...
  `qst_tpl_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `exam_qst` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_k042lspm33256y5nqs33bb7xg` (`exam_id`),
  CONSTRAINT `FK_k042lspm33256y5nqs33bb7xg` FOREIGN KEY (`exam_id`) REFERENCES `exam` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `qst_tpl` VALUES (1,NULL,'432',NULL);
...
INSERT INTO `qst_tpl_item` VALUES (1,'423',NULL,'4324',NULL,1),(2,'432',NULL,'',NULL,1);
...
INSERT INTO `user` VALUES (7,'admin888','7ca9d77f852e7205d74f7e91bbc5d40d','72acf2e2e5ff4f17882b4173832fa43f',NULL,NULL,NULL,0,0,'2015-06-28 08:29:32','2015-06-28 08:29:32','lvyahui8@126.com',NULL,'','admin','/slsxpt//upload/images/a25e2626494beb2a0d1f27b28a2032f0.jpg',NULL),(9,'lvyahui','00b25acc721a6989148fd2491233a71a','3464b746e8c44ff9b97c20826cf05348',NULL,NULL,NULL,0,0,'2015-06-28 14:32:25','2015-06-28 14:32:25','lvyahui6@163.com',NULL,'3340b609ed484d29b3d0da38802afc7a','root','/slsxpt//upload/images/a45b0f9c27ff4ce94a259a5d5961e810.jpg',NULL),(10,'devlyh','f9ad039fbe35fcedcf5482f7ca587d1b','5effef4761b840a29c70839f0279f5e6',NULL,NULL,NULL,0,0,'2015-07-19 11:57:03','2015-07-19 11:57:03','devlyh@163.com',NULL,'','customer',NULL,NULL);
...
INSERT INTO `video` VALUES (1,27,7,'111','111','/slsxpt//upload/video/f19fe888f6ba89e8773e50009e04a399.mp4','/slsxpt//upload/images/7cd482e35fc6795204de0fc232282819.jpg',0,0,0,'2015-11-13 04:30:12','2015-11-13 04:30:12');
...
-- Dump completed on 2015-11-22 12:06:52
