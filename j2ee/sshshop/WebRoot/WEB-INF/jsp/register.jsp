		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm"  method="post" novalidate="novalidate"  action="/user_register.action">
						<div class="row">
						...
						<div class="row">
							...
							<span class="fieldSet">
								...
								<img id="captchaImage" class="captchaImage" src="./image/captcha.jhtml" title="点击更换验证码">
							</span>
						</div>
						<div class="row">
							<input type="submit" class="submit" value="同意以下协议并注册">
							注册协议<div id="agreement" class="agreement" style="height: 200px;">
