...
public:
	...
	void update()
	{
		...
		if(bShowTips)
		{
			...
			outtextxy(10, 10, "临近期末,在此祝愿各位同学:");
			outtextxy(10, 50, "逢考必过,人人都是挂柯南（难）!");
			//outtextxy(10, 50, "使用BackSpace 或 Delete键可以撤销上一次的画线，直至消除所有直线.");
			outtextxy(10, 90, "也希望同学们在今后的3年里硕果丰收。");
			...
			//outtextxy(100, 300, "按esc键之后本提示将消失，再按就会回来~");
			outtextxy(300, 300, "湖中大12级计算机班");
			outtextxy(300, 320, "        ----吕亚辉");
		}
	}
